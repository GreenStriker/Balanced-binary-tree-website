...
<div style="padding-left:300px;"  class="col-md-8">
    <div class="form-group">
      <label for="email">Product Code:</label>
        <asp:TextBox ID="Point" class="form-control" placeholder="Enter Product Code" runat="server" ></asp:TextBox>
         <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Product Code Require" ControlToValidate="Point" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
</div>
</div>
