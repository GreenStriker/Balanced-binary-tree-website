...
public partial class Registration_Registration : System.Web.UI.Page
{
    ...
    public bool username_Check()
    {
        ...
        string constring = "server=localhost;database=mlm;uid=shield;pwd=54321;"; // chage here
        ...
        if (!username_Check())
       {
            ...
            try
            {
               ...
               // cmd.CommandText = "insert into user (name,email,password) values ('" + name.Text + "','" + email.Text + "',MD5 ('" + password.Text + "') )";
                cmd.CommandText = "insert into userinfo (full_name,username,password,email,parent,f_name,nomini_name,nomini_relation,dob,p_id,mobile,address,country,bank_account,nid,direct_income_acc,status,Gender,banckname,bankbranc,nphone) values ('" + name.Text + "','" + username.Text + "','" + password.Text + "','" + email.Text + "','" + parent.Text + "','" + father.Text + "','" + Nomini.Text + "','" + Nomini_Relation.Text + "','" + dob.Text + "','" + p_id.Text + "','" + Mobile.Text + "','" + address.Text + "','" + country.Text + "','" + bank_account.Text + "','" + nid.Text + "','" + D_income.Text + "','deactive','" + Gender.SelectedItem.Value + "','" + banckname.Text + "','" + bankbranc.Text + "','" + nphone.Text + "')";
