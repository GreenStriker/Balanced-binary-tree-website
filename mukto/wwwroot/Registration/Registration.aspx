	...
	<div class="row">
					...
					<div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="nid" rows="3" class="form-control" runat="server" placeholder="Enter your NID Number" ></asp:TextBox>
                         ...
                         <div class="row">
							...
							<div class="col-sm-6 form-group">
							 ...
							 <asp:TextBox ID="dob" class="form-control" runat="server" placeholder="Enter your Birth Date" TextMode="Date"></asp:TextBox>
						...
						<div class="row">
							...
							<div class="col-sm-4 form-group">
								<label>Nominee Name :</label>
								 <asp:TextBox ID="Nomini" class="form-control" runat="server" placeholder="Enter your Nominee name"></asp:TextBox>
							...
							<div class="col-sm-4 form-group">
								<label>Nominee Relation :</label>
								 <asp:TextBox ID="Nomini_Relation" class="form-control" runat="server" placeholder="Enter your Nominee Relation"></asp:TextBox>
                        ...
                        <div class="row">
							<div class="col-sm-6 form-group">
								...
								<asp:TextBox ID="Mobile" class="form-control" runat="server" placeholder="Enter your Mobile Number" ></asp:TextBox>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="email" Display="Dynamic" ErrorMessage="Email Is Not valid" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                         ...
                         <div class="row">
							<div class="col-sm-6 form-group">
							 ...
							 <asp:TextBox ID="p_id" class="form-control" runat="server" placeholder="Enter your Product Code"></asp:TextBox>
                       ...
                       <div class="row">
                        <div class=" col-sm-6 form-group">
                            ...
                            <asp:TextBox ID="parent" class="form-control" runat="server" placeholder="Enter your Referral Account"></asp:TextBox>
                        ...
                        <div class=" col-sm-6 form-group">
                            ...
                            <asp:TextBox ID="banckname" class="form-control" runat="server" placeholder="Enter your Bankname"></asp:TextBox>
                        ...
                        <div class=" col-sm-6 form-group">
							<label>Bank branch:</label>
                                  ...
                                  <asp:TextBox ID="bankbranc" class="form-control" runat="server" placeholder="Enter your Bankbranc"></asp:TextBox>
								  
								  
                            </div>

                             <div class=" col-sm-6 form-group">
							<label>Nomini Phone No:</label>
							
                            <asp:TextBox ID="nphone" class="form-control" runat="server" placeholder="Enter your Bankname"></asp:TextBox>
