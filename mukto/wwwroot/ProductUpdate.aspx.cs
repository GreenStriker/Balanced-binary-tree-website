...
public partial class Admin_ProductUpdate : System.Web.UI.Page
{
   ...
   string path1;
    ...
    protected void Product_update_Click(object sender, EventArgs e)
    {
       ...
       cmd2.CommandText = "UPDATE product set productWarinty='" + warinty.Text + "',productDescription='" + description.Text + "',productName='" + name.Text + "',productPoint='" + Point.Text + "', productPrice='" + price.Text + "'  where product_ID='" + pid + "' ";
           //MySqlDataReader r1;
