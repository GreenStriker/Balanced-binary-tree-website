...
public partial class UserUpdate : System.Web.UI.Page
{
    ...
    public void AllUser()
    {
        ...
        while (r1.Read())
        {
            ...
            Gender.Text = r1.GetString("Gender").ToString();
            banckname.Text = r1.GetString("banckname").ToString();
            bankbranc.Text = r1.GetString("bankbranc").ToString();
            nphone.Text = r1.GetString("nphone").ToString();
    ...
    protected void User_update_Click(object sender, EventArgs e)
    {
        ...
        Response.Write("<script> alert('User Update Successfully');</script>");
