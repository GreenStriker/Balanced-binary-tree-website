    ...
    <section id="feature">
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>About</h2>
                <p class="lead">The company is about marketing and selling Goods </p>
               <p class="lead">... </p>
               <p class="lead">... </p>
            </div>
            ...
            <div class="col-lg-4 col-sm-4">
                <div class="preview">
                    ...
                    <div class="options">
                           ...
                           <p>Product Price   :<%#Eval("productPrice") %></p>
                           <p>Product Code :<%#Eval("productPoint") %></p>
    ...
    <div class="row">
		...
		<div class="col-lg-4">
			<div class="widget-contact">
				<h6>Muktobazar Bangladesh</h6>
				
				<address>
				  <strong>OWNER : MD. ABDULLAH-AL-MUTI  </strong><br>
				ADDRESS : <br>
				      2/3,B,B,FRIST LANE, ARUAPARA,<br>MOHINI MILLS - 7001,<br>KUSHTIA SADAR, <br>KUSHTIA ,BANGLADESH <br>
				  <abbr title= "Phone">Mobile Number:</abbr> 01712716324
				</address>

				<address>
				  <strong>Email</strong><br>
				  <a href="mailto:#">muktobazarbdkushtia@gmail.com</a>
				</address>	
				<address>
			...
			<p> <a href="http://www.shieldsoftbd.com"> Powered By - ShieldSoft Bangladesh - 2017.</a></p>
			</div>	
		</div>
    </div>	
